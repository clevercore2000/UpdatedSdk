...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 93.5;
        FollowerConstants.yMovement = 73.31;

        FollowerConstants.forwardZeroPowerAcceleration = -80.9;
        FollowerConstants.lateralZeroPowerAcceleration = -173.2;
        ...
        FollowerConstants.headingPIDFCoefficients.setCoefficients(2,0,0.3,0.15);
